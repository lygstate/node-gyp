...
function build (gyp, argv, callback) {
  ...
  /**
   * Copies the [node|iojs].lib file for the current target architecture into the
  ...
  function copyNodeLib () {
    ...
    var buildDir = path.resolve(nodeDir, buildType)
      , archNodeLibPath = path.resolve(nodeDir, arch, distLibName + '.lib')
      , buildNodeLibPath = path.resolve(buildDir, distLibName + '.lib')
    ...
    mkdirp(buildDir, function (err, isNew) {
      ...
      log.verbose('copying "' + distLibName + '.lib" for ' + arch, buildNodeLibPath)
      rs.pipe(ws)
